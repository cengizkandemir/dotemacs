(custom-set-variables
 ...
 '(package-selected-packages
   '(projectile move-text ccls company-lsp lsp-ui lsp-mode company flycheck cmake-mode magit pdf-tools auctex restart-emacs nyan-mode zenburn-theme use-package)))
(custom-set-faces
